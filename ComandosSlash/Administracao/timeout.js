...
module.exports = {
    name: "timeout",
    description: "✦ » Staff - Castigue um membro!",
    type: Discord.ApplicationCommandType.ChatInput,
    options: [
        {
            name: "usuario",
            description: "✦ » Staff - O usuário que você quer dar um timeout.",
            type: Discord.ApplicationCommandOptionType.User,
            required: true,
        },
        {
            name: "duração",
            description: "✦ » Staff - Duração do timeout (20s, 30m, 1h, 1day).",
            type: Discord.ApplicationCommandOptionType.String,
            required: true,
        },
        {
            name: "motivo",
            description: "✦ » Staff - O motivo para o timeout.",
            type: Discord.ApplicationCommandOptionType.String,
            required: false,
        },
    ],
